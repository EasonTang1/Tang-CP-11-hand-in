...
public class Test {
    ...
    public static void main(String args[]){
        Customer c = new Customer("kan k",737800,787,747);
        ...
        date = cal.getTime();
        c.deposit(500, date,Customer.SAVING); //deposit 500
        c.displayDeposits();
        ...
        //Withdraw of: $500.0 Date: Thu Aug 16 10:52:17 PDT 2018 into account: Saving
        cal.set(Calendar.MONTH, 7);    //to set date
        cal.set(Calendar.DATE, 16);
        cal.set(Calendar.YEAR, 2018);
        cal.set(Calendar.HOUR_OF_DAY,10);
        ...
        cal.set(Calendar.SECOND,17);
        date = cal.getTime();
        c.withdraw(500, date,Customer.SAVING); //withdraw 500
        c.displayWithdraws();
    }
}
